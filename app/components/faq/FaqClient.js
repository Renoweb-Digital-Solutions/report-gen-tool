...
export default function FaqClient() {
  ...
  const ALL_FAQS = [
    ...
    },
    {
      ...
      a: "Yes, you can generate a free digital audit report with no credit card required, and upgrade when you need higher daily report limits or white label branding."
    },
    {
      q: "How long does a report take to generate?",
      a: "Most single module and full audit reports are generated within 60 to 90 seconds."
    }
  ];
